 ...
 * @var string
 */
$site = "http://".$_SERVER['HTTP_HOST']."/semedt/";
/**
 * URL parse method
...
// example
$semevar['site_title'] = 'Datatable Demo - Seme Framework';
$semevar['site_tagline'] = 'Deployable PHP MVC Framework';
$semevar['site_description'] = 'Learn more about using datatable using Seme Framework version 4.0.0';
